...
parser.add_argument('--consensus_type', type=str, default='LSTM', choices=['avg', 'MLP', 'LSTM'])
...
net = STSNN(num_class, args.test_segments if args.consensus_type in ['MLP'] else 1, args.modality,
